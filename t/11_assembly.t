...
my $assembly;
lives_ok { $assembly = Assembly->load_assembly('/home/testuser/ERS111111_123456789a123456789b123456789cdc.fa') }
...
throws_ok { Assembly->load_assembly('/home/testuser/ERS111111_123456789a123456789b123456789cdc.fa') }
  qr/failed to load file/,
  "can't load same file again";
is( Assembly->count, 2, 'still two assemblies loaded' );

throws_ok { Assembly->load_assembly('ERS333333_123456789a123456789b123456789cdc.fa') }
  qr/must be a full path/,
  "can't load file without full path";

throws_ok { Assembly->load_assembly('/home/testuser/ERS333333_123456789a123456789b123456789cdc') }
  qr/couldn't parse file path/,
  "can't load file without suffix";

throws_ok { Assembly->load_assembly('/home/testuser/333333_123456789a123456789b123456789cdc') }
  qr/couldn't parse file path/,
  "can't load file with bad ERS number";

throws_ok { Assembly->load_assembly('/home/testuser/ERS333333_23456789a123456789b123456789cdc.fa') }
