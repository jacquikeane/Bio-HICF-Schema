...
my $assembly;
lives_ok { $assembly = Assembly->load('/home/testuser/ERS111111_123456789a123456789b123456789cdc.fa') }
...
throws_ok { Assembly->load('/home/testuser/ERS111111_123456789a123456789b123456789cdc.fa') }
  qr/failed to load file/,
  "can't load same file again";
is( Assembly->count, 2, 'still two assemblies loaded' );

throws_ok { Assembly->load('ERS333333_123456789a123456789b123456789cdc.fa') }
  qr/must be a full path/,
  "can't load file without full path";

throws_ok { Assembly->load('/home/testuser/ERS333333_123456789a123456789b123456789cdc') }
  qr/couldn't parse file path/,
  "can't load file without suffix";

throws_ok { Assembly->load('/home/testuser/333333_123456789a123456789b123456789cdc') }
  qr/couldn't parse file path/,
  "can't load file with bad ERS number";

throws_ok { Assembly->load('/home/testuser/ERS333333_23456789a123456789b123456789cdc.fa') }
  qr/can't find ERS number and MD5 in filename/,
  "can't load file with bad MD5";

throws_ok { Assembly->load('/home/testuser/ERS999999_123456789a123456789b123456789cdc.fa') }
  qr/no such sample/,
